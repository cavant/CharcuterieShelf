...
import { AbsFileSystem, AbsThemePlugin } from '@/plugins/capacitor'
...
export default ({ store, app }, inject) => {
  ...
  // Set theme & dynamic color support
    ...
    if (theme === 'material-you') {
      try {
        ...
        if (colors?.isAvailable) {
          if (colors.accent) document.documentElement.style.setProperty('--dynamic-accent', colors.accent)
          if (colors.accentLight) document.documentElement.style.setProperty('--dynamic-accent-light', colors.accentLight)
          if (colors.bg) document.documentElement.style.setProperty('--dynamic-bg', colors.bg)
          if (colors.primary) document.documentElement.style.setProperty('--dynamic-primary', colors.primary)
          if (colors.secondary) document.documentElement.style.setProperty('--dynamic-secondary', colors.secondary)
          if (colors.border) document.documentElement.style.setProperty('--dynamic-border', colors.border)
          if (colors.fg) document.documentElement.style.setProperty('--dynamic-fg', colors.fg)
          if (colors.fgMuted) document.documentElement.style.setProperty('--dynamic-fg-muted', colors.fgMuted)
        }
      } catch (e) {
