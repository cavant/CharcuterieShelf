...
describe('GitHub Actions CI/CD Workflows & Issue Templates Integrity', () => {
  ...
  test('Bug report and feature request templates reference CharcuterieShelf versions', () => {
    ...
    assert.ok(bugReport.includes('0.14.13-beta'), 'bug_report.yml must list current version 0.14.13-beta');
    assert.ok(featureReq.includes('0.14.13-beta'), 'feature_request.yml must list current version 0.14.13-beta');
  });
