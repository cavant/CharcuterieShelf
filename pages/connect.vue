  ...
  <div class="w-full h-full">
    <div class="relative flex items-center justify-center min-h-screen sm:pt-0">
      ...
      <div class="absolute top-0 left-0 w-full p-6 flex items-center flex-col justify-center z-0 short:hidden">
        ...
        <h1 class="text-2xl font-bold">CharcuterieShelf</h1>
      </div>
      <p class="hidden absolute short:block top-1.5 left-12 p-2 text-xl font-bold">CharcuterieShelf</p>
    ...
    <div class="flex items-center justify-center pt-4 fixed bottom-4 left-0 right-0">
      <a href="https://github.com/cavant/CharcuterieShelf" target="_blank" class="text-sm pr-2">{{ $strings.MessageFollowTheProjectOnGithub }}</a>
      <a href="https://github.com/cavant/CharcuterieShelf" target="_blank"
